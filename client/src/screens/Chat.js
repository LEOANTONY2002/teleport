...
const socket = io.connect("https://leoteleportsocket.herokuapp.com");
...
function Chat() {
    ...
    return ( <
            ...
            mes ? .messageList ? .map((m) => ( <
                ...
                className = { m ? .from === user ? .user ? .user ? ._id ? "right" : "" } >
                {
                    ...
                    m ? .photo ? ( <
                        >
                        <
                        img src = { m ? .photo.toString("base64") }
                        alt = "" / >
                        <
                        />
                    ) : ( <
        ...
        div className = "cam" >
        <
        img src = "https://img.icons8.com/small/24/ffffff/camera.png"
        alt = "" /
        >
        <
